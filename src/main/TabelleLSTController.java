...
public class TabelleLSTController implements Initializable {
    ...
    // Innere Klasse, die eine Zeile in der Tabelle repräsentiert,
    // wobei jeder Block in einem eigenen Feld gespeichert wird.
    public static class DataRow {
        ...
        public void setBlock6(String value) {
            block6.set(value);
        }
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // FilePicker-Button: Beim Klick wird ein Dateidialog geöffnet und danach die Tabelle neu geladen
        if (btnFilePicker != null) {
            btnFilePicker.setOnAction(e -> {
                FileChooser fileChooser = new FileChooser();
                // Setze das gewünschte Anfangsverzeichnis
        ...
        // Optional: Lade beim Start einen Standardpfad
        String defaultPath;
        String osName = System.getProperty("os.name").toLowerCase();
        if (osName.contains("win")) {
            ...
            defaultPath = "/Users/eddywayz/Desktop/Studium/Rechnerarchitektur/test_files/TPicSim12.LST";
    ...
    /**
     * Liest die Datei unter dem gegebenen Pfad ein und aktualisiert die TableView.
     */
    ...
    /**
     * Zerlegt eine Zeile in mehrere Blöcke (Spalten).
     */
